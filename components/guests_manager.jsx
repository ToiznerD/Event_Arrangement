...
export default function GuestsManager({data}) {
  ...
  return (
    <Layout title={title}>
      <div className="overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 max-h-[500px] scrollbar-track-gray-100 md:w-[590px]">
        <table>
          <thead>
      ...
      <div className="flex flex-col justify-center">
        ...
        <button onClick={saveChanges} className={"bg-red-400 hover:bg-red-500 text-white font-bold py-2 px-4 mt-2 rounded" + " w-[200px] mx-auto text-center"}>Save Changes</button>
      </div>
