...
export default function Layout({ children, title, width }) {
    ...
    return (
        ...
        <Head>
            ...
            <div className={`border-2 border-white rounded-3xl shadow-lg shadow-slate-500 min-h-[300px] w-screen max-w-[500px] md:w-[${width > 0 ? width : 500}px] md:max-w-[1500px] overflow-hidden mx-1`}>
